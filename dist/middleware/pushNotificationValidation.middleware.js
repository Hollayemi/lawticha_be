...
exports.validateNotificationUpdate = exports.validateNotificationCreate = void 0;
const error_1 = require("./error");
// Validate notification creation
const validateNotificationCreate = (req, res, next) => {
    const { title, message, targetAudience, scheduleType, scheduledAt, specificUserIds, specificDriverIds } = req.body;
    const errors = {};
    // Title validation
...
exports.validateNotificationCreate = validateNotificationCreate;
...
exports.validateNotificationUpdate = validateNotificationUpdate;
//# sourceMappingURL=pushNotificationValidation.middleware.js.map