...
exports.UserProgressModel = exports.EnrollmentModel = void 0;
...
const EnrollmentSchema = new mongoose_1.Schema({
    ...
    lessonsCompleted: [{ type: mongoose_1.Schema.Types.ObjectId }], // lesson._id list
    currentLessonId: { type: mongoose_1.Schema.Types.ObjectId }, // lesson currently on
...
exports.EnrollmentModel = mongoose_1.models.Enrollment || (0, mongoose_1.model)('Enrollment', EnrollmentSchema);
// 
/**
...
const UserProgressSchema = new mongoose_1.Schema({
    ...
    moduleId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'LegalModule', required: true },
    lessonId: { type: mongoose_1.Schema.Types.ObjectId, required: true },
    enrollmentId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Enrollment', required: true },
    status: {
        type: String,
...
exports.UserProgressModel = mongoose_1.models.UserProgress || (0, mongoose_1.model)('UserProgress', UserProgressSchema);
